...
<head>
  ...
  <title ng-bind-template="API Documentation: {{partialTitle}}">Docs</title>
  <script type="text/javascript">
    ...
    (function() {
      ...
      addTag('link', {rel: 'stylesheet', href: 'css/animations.css', type: 'text/css'});
        ...
        addTag('script', {src: 'js/angular-animate.min.js'}, sync);
      
        addTag('script', {src: 'js/marked.js'}, sync);
      
        addTag('script', {src: 'js/dist/angular-screenfull.js'}, sync);
      
        addTag('script', {src: 'https://cdnjs.cloudflare.com/ajax/libs/screenfull.js/4.0.0/screenfull.js'}, sync);
    ...
    var _gaq = _gaq || [];
    _gaq.push(['_setAccount', 'UA-44454147-3']);
    _gaq.push(['_setDomainName', 'http://hrajchert.github.io/angular-screenfull/']);
    ...
    <div class="navbar navbar-fixed-top">
      <div class="navbar-inner">
        <div class="container">
            ...
            <a  class="brand">API Documentation</a>
